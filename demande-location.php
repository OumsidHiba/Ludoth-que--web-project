...
if ($estMembre) {
    $erreurs[] = "Les membres doivent faire une demande d'emprunt, pas de location.";
}

if ($statutJeu !== "en stock") {
    $erreurs[] = "Ce jeu n'est pas disponible à la location.";
}
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && empty($erreurs)) {
    ...
    if ($dateDebut === "" || $dateFin === "") {
        ...
        $succes = "Votre demande de location a bien été envoyée.";
    }
}
...
<main class="section">
    <h1 class="section-title">Demande de location</h1>
    ...
    <?php elseif (!$estMembre && $statutJeu === "en stock"): ?>
        <div class="account-card" style="max-width:700px;margin:0 auto;">
            <p class="account-text">
                Vous allez envoyer une demande de location pour
